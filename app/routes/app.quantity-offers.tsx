                                                    ...
                                                    {(mergedFields as any[])
                                                        ...
                                                        .map((field: any) => {
                                                            ...
                                                            if (field.id === 'order_summary') {
                                                                return (
                                                                    <div key={field.id} style={{
                                                                        ...
                                                                        borderRadius: '10px', padding: '12px', marginTop: '16px', marginBottom: '16px',
                                                            ...
                                                            const fieldIcons: Record<string, React.ReactNode> = {
                                                                ...
                                                                zipcode: <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke={iconColor} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0 1 18 0z" /><circle cx="12" cy="10" r="3" /></svg>,
                                                            };
