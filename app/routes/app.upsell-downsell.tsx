...
export default function UpsellDownsellPage() {
    const { shopDomain, campaigns: initialCampaigns, formSettings, shopCurrency, partialPaymentSettings } = useLoaderData<typeof loader>();
                                                    ...
                                                    <div className="tick-pv-product" style={(() => {
                                                        ...
                                                        {formSettings?.form_subtitle && (
                                                            ...
                                                            <div className="cod-trust-badge-band" style={{
                                                                ...
                                                                fontFamily: formSettings?.styles?.fontFamily || 'Inter',
                                                                fontSize: 'clamp(6.2px, 1.3vw, 8px)',
                                                                fontWeight: 600,
                                                                color: '#000000',
                                                            ...
                                                            {(mergedFields as any[])
                                                                ...
                                                                .map((field: any) => {
                                                                                ...
                                                                                <div style={{ display: 'flex', flexDirection: 'column', gap: '14px' }}>
                                                                                    ...
                                                                                    {showFullPrepaid && (
                                                                                        <label style={{
                                                                                            ...
                                                                                            <div style={{ display: 'flex', alignItems: 'center', gap: '8px', padding: partialPaymentSettings?.payment_method_tags?.full_prepaid?.enabled ? '18px 10px 8px 10px' : '8px 10px' }}>
                                                                                                {/* Icon */}
                                                                    ...
                                                                    const fieldIcons: Record<string, React.ReactNode> = {
                                                                        ...
                                                                        star: <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke={iconColor} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><polygon points="12 2 15.09 8.26 22 9.27 17 14.14 18.18 21.02 12 17.77 5.82 21.02 7 14.14 2 9.27 8.91 8.26 12 2" /></svg>,
                                                                        note: <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke={iconColor} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z" /><polyline points="14,2 14,8 20,8" /><line x1="16" y1="13" x2="8" y2="13" /><line x1="16" y1="17" x2="8" y2="17" /><polyline points="10,9 9,9 8,9" /></svg>,
                                                                        location: <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke={iconColor} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0 1 18 0z" /><circle cx="12" cy="10" r="3" /></svg>,
                                                                    };
