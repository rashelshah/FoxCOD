...
/* ── Tabs ── */
.tabs { display: flex; gap: 4px; margin-bottom: 24px; background: rgba(255, 255, 255, 0.9); backdrop-filter: blur(12px); -webkit-backdrop-filter: blur(12px); padding: 6px; border-radius: 10px; border: 1px solid rgba(229, 231, 235, 0.8); box-shadow: 0 10px 15px -3px rgba(0, 0, 0, 0.05), 0 4px 6px -2px rgba(0, 0, 0, 0.025); }
